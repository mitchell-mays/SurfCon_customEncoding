...
for epoch in range(args.num_epochs):
    ...
    for cur_sample in train_pos:
        ...
        # For testing comming below and using criterion
        rank_loss = model.listwise_cost(logits, onehot_labels)
        #rank_loss = criterion(logits, ce_labels)
        rank_loss_test = criterion(logits, onehot_labels)
        #print("rank loss test : ", rank_loss , rank_loss_test)
        #loss = rank_loss
        loss = rank_loss_test
